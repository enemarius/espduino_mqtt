...
void setup()
{
  ...
  WiFiManagerParameter custom_inputtag("inputtag", "input tag", "defaultPlaceholder", 10);
  wifiManager.addParameter(&custom_inputtag);
  ...
  if (shouldSaveConfig) {
    ...
    Serial.println("Custom param:");
    Serial.println(custom_inputtag.getValue());
